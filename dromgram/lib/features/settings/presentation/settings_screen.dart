    ...
    return Scaffold(
      ...
      body: _loading ? const Center(child: CircularProgressIndicator())
        : ListView(children: [
          ...
          const Divider(height: 0),
          _buildSection('DRomGram Premium', [
            _buildTile(Icons.star, 'Premium', onTap: () => context.push(RouteNames.premium)),
            _buildTile(Icons.monetization_on, 'Звёзды', onTap: () => context.push(RouteNames.stars)),
            _buildTile(Icons.card_giftcard, 'Маркет подарков', onTap: () => context.push(RouteNames.gifts)),
          ]),
          _buildSection('Аккаунт', [
            ...
            _buildTile(Icons.block, 'Заблокированные пользователи', onTap: () => context.push(RouteNames.blockedUsers)),
          ]),
          _buildSection('Внешний вид', [
            _buildTile(Icons.palette_outlined, 'Темы', onTap: () => context.push(RouteNames.themes)),
          ]),
          _buildSection('Уведомления', [
            _buildTile(Icons.notifications_outlined, 'Уведомления', onTap: () => context.push(RouteNames.notifications)),
          ]),
          _buildSection('Данные', [
            _buildTile(Icons.storage_outlined, 'Хранилище', onTap: () => context.push(RouteNames.storage)),
          ]),
          _buildSection('Аккаунт', [
