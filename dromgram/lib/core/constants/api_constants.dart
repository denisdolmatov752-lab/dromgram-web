class ApiConstants {
  ...
  // Gifts
  static const String gifts = '/gifts/nfts';
  static const String myGifts = '/gifts/my';
  static const String sendGift = '/gifts/send';

  // Stars
  static const String starsBalance = '/stars/balance';
  static const String starsTransactions = '/stars/transactions';
  static const String starsPurchase = '/stars/purchase';

  // Premium
  static const String premiumStatus = '/premium/status';
  static const String premiumSubscribe = '/premium/subscribe';
  static const String userPremium = '/users/me/premium';
}
